...
### [dHCP 3rd release + fetal](https://nda.nih.gov/edit_collection.html?id=3955)
...
885+ postnatal brain MRI (T1w,T2w,dMRI and rsfMRI) of infants and fetal subjects; processed with own pipeline    

**Keywords**: longitudinal, newborn, fetal; large, premature, postnatal, T1w, T2w, dMRI, rsfMRI, labels
...
**Keywords**: pediatric, rsfMRI, dMRI, anatomical, development
...
**Keywords**: T1w, pediatric, segmentation, manual
...
### [**Richardson-OpenNeuro:**](https://openneuro.org/datasets/ds000228/versions/1.1.0/download)
